...
add_filter('wpjam_baidu_zz_setting', function(){
	return	[
		'title'		=>'', 
		'summary'	=>'<p>百度推送扩展由 WordPress 果酱和 纵横SEO 联合推出。<br /><a href="https://www.baidufree.com">纵横SEO</a> 助你从百度获取更多免费流量。</p>',
		'fields'	=>[
			'site'	=>['title'=>'站点 (site)',	'type'=>'text'],
...
add_filter('wpjam_xzh_setting', function(){
	return	[
		'title'		=>'', 
		'fields'	=>[
			'appid'	=>['title'=>'熊掌号 (appid)',	'type'=>'text'],
			'token'	=>['title'=>'密钥 (token)',		'type'=>'text'],
		]	
	];
});
...
function wpjam_baidu_zz_batch_page(){
	?>
	<h2>批量提交</h2>
	<p>使用熊掌号历史内容接口批量将博客中的所有内容都提交给百度熊掌号。</p>
	<?php 
