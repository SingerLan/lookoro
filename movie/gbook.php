...
function viewLeaveWord(){
	...
	$key=$_GET['key'];
if($key=="" OR empty($key)){$keytxt="";}else{$keytxt="管理员您好，请求添加《".$key."》辛苦啦！";}
	$mystr=
...
"</li>".
"<li><textarea cols=\"40\" class=\"form-control\" name=\"m_content\" id=\"m_content\" rows=\"5\" placeholder=\"输入留言内容\">".$keytxt."</textarea></li>".
