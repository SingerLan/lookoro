var __encode = 'lookoro.cn',
    _0xb483 = ["_decode", "http://www.lookoro.cn"];
(function(_0xd642x1) {
    _0xd642x1[_0xb483[0]] = _0xb483[1]
})(window);
var __Ox4c7c4 = ["localhost,www.lookoro.cn,lookoro.cn",
 "indexOf", "hostname", "location", "empty", "head,body", 
 "<div style=\"text - align: center; font - size: 28px \">抱歉，该域名暂无授权，如需使用请联系QQ：2189154548</div>",
 "prepend", "body", "URL", "domain", "title", "pathname", "toLowerCase", "browserLanguage", "language", "getContext",
 "canvas", "createElement", "userAgent", "match", "Android", "Linux", "iPhone", "Mac", "iPad", "Trident", "Presto", 
 "AppleWebKit", "Gecko", "KHTML", "MicroMessenger", "am-modal-active", "addClass", ".am-share", "length", ".sharebg", 
 "sharebg-active", "<div class=\"sharebg \"></div>", "append", "removeClass", ".sharebg-active", "remove", "click", 
 ".sharebg-active,.share_btn", ".open-share", "weixin", "useragent", "browser", 
 "<li><a rel=\"nofollow \" href=\"https: //mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MzU4NTY2OTQ3Ng==&scene=126&bizpsid=0#wechat_redirect\" target=\"_blank\">小说</a></li>", 
 "after", "#xiao", "path", "https://cdn.bootcss.com/Swiper/3.4.2/js/swiper.min.js", 
 ".banner-top", ".swiper-button-prev", ".swiper-button-next", ")", "http://www.lookoro.cn", "replace", 
 "url(", "backgroundImage", "css", ".banner-top .swiper-slide-active a", "style", "bgimage", "getElementById", ".banner-wtop", 
 ".swiper-pagination", "run", "adaptiveBackground", ".art_banner", "getScript", "width", "overhidden", "html,body", "menu_block", ".all_menu", ".close_menu", ".menu", "show", "eq", "hide", "hover", "each", ".head_menu_b", "hash", "top", "offset", "animate", "scrollTop", "height", "nav_fixed", "#topnav,.listnow,.art_navlist", "scroll", "adfixed", ".ads_rbox", "search_btn", ".submit", "focus", "input.form_control", "blur", "/templets/lookoro8000/images/js/iscroll.js", "navbarscroll", ".wrapper", ".ik-n-01", "#ik01", ".ik-n-02", "#ik02", ".ik-n-03", "#ik03", ".ik-n-04", "#ik04", ".ik-n-05", "#ik05", ".ik-n-06", "#ik06", "slow", "slideToggle", ".panel", "toggle", ".xs1", ".xs2", ".flip", "#bottom_ads", "foot_stem", ".foot", ".close_ads_btn", "#fd_tips", ".close_tips", "#short", "#short2", "https://api.weibo.com/2/short_url/shorten.json", "val", "#app_key", "#shareurl", "?source=", "&url_long=", "url", "urlpath", "GET", "jsonp", "urls", "data", "url_short", "ajax", "https://cdn.bootcss.com/jquery_lazyload/1.9.7/jquery.lazyload.min.js", "fadeIn", "lazyload", ".lazyload", ".list_scroll .vodlist_thumb", "boxload", ".vodlist_sm,.vodlist_sh", ".boxload", "https://cdn.bootcss.com/jquery.qrcode/1.0/jquery.qrcode.min.js", "qrcode", ".cans", "src", "image/png", "toDataURL", ".qrcode", "a.backtop", "display", "block", "none", "html, body", "on", "https://cdn.bootcss.com/clipboard.js/2.0.4/clipboard.min.js", "copy_btn", "getElementsByClassName", "success", "slideUp", "delay", "slideDown", "#show", "log", "error", "#wx_name", "#wx_qrcode", "#zans_qrcode", "<div class=\"ikan_wrap\"><div class=\"mac_pop_bg\"></div><div class=\"ikan_content\"><div class=\"ikan_content_hd\"><h4 class=\"ikan_content_title\">关注后微信观看</h4></div><div class=\"ikan_content_bd\"><img class=\"info_img\" src=\"", "\" alt=\"公众号二维码\"><p>长按识别二维码或微信扫码关注</p><p>关注后回复片名即可</p><p>或微信搜索微信名：<span style=\"color: #f44336;\">", "<span></p></div><div class=\"ikan_content_ft\"><a class=\"close_box\" href=\"javascript:;\">下次再说</a></div></div></div>", ".ikan_wrap", ".close_box,.mac_pop_bg", ".btn_wxgzh", "<div class=\"ikan_wrap\"><div class=\"mac_pop_bg\"></div><div class=\"ikan_content\"><div class=\"ikan_content_hd\"><h4 class=\"ikan_content_title\">感谢赞赏</h4></div><div class=\"ikan_content_bd\"><img class=\"info_img\" src=\"", "\" alt=\"赞赏二维码\"><p>长按识别二维码或微信扫描二维码</p>金额随意，多少都是支持</p></div><div class=\"ikan_content_ft\"><a class=\"ikan_btn_no\" href=\"javascript:;\">残忍拒绝</a><a class=\"close_box\" href=\"javascript:;\">取消</a></div></div></div>", "就知道你会点，哼~，不过还要祝你观影愉快～！", ".ikan_btn_no", ".btn_zhans", "mobile", "share", "xiaoshuo", "swiper", "menu", "fixed", "wrapper", "flip", "closebtn", "shorturl", "images", "scrolltop", "copy", "wxqrcode", "ready"];
...
var ikan = {
    ...
    copy: function() {
        $[__Ox4c7c4[0x48]](maccms[__Ox4c7c4[0x34]] + __Ox4c7c4[0xa7], function() {
            ...
            var _0x63d3x1b = new ClipboardJS(_0x63d3x1a);
